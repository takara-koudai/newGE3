...
void DirectXCommon::Initialize(WinApp* winApp)
{
    ...
    //深度バッファ
    DepthBufferTargetInitialize();
    //フェンス
    FenceTargetInitialize();
...
void DirectXCommon::DepthBufferTargetInitialize()
{
    HRESULT result;
    // リソース設定
...
void DirectXCommon::FenceTargetInitialize()
{
    HRESULT result;
...
ID3D12DescriptorHeap* DirectXCommon::CreateDescripterHeap(D3D12_DESCRIPTOR_HEAP_TYPE heapType, UINT numDescripots, bool shaderVisible)
{
